...
public class MuPDFPageAdapter extends BaseAdapter {
    ...
    private List<EditorModel> mEditormodel;

    public MuPDFPageAdapter(Context c, FilePicker.FilePickerSupport filePickerSupport,
                            MuPDFCore core, List<EditorModel> model) {
        mContext = c;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            pageView.setmListEditor(mEditormodel);
        } else {
